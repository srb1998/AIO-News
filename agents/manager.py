...
class ManagerAgent:
    def __init__(self, social_media_manager: SocialMediaManagerAgent):
        """
        Initializes the ManagerAgent by accepting a pre-configured 
        SocialMediaManagerAgent instance.
        """
        self.name = "NewsManager"
        
        # This agent will use the bot and smm that are passed in
        self.social_media_manager = social_media_manager
        self.telegram_bot = self.social_media_manager.telegram_bot
        ...
        self.telegram_bot.set_manager_agent(self)
